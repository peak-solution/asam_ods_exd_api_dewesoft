# GitHub: ghcr.io/<repository_owner>/asam-ods-exd-api-dewesoft:latest
# docker build -t ghcr.io/peak-solution/asam-ods-exd-api-dewesoft:latest .
# docker run --rm -it -v "$(pwd)/data":"$(pwd)/data" -p 50051:50051 ghcr.io/peak-solution/asam-ods-exd-api-dewesoft:latest
